...
describe('useSettingsStore', () => {
  ...
  it('updateSetting calls invoke with JSON string for complex values', async () => {
    ...
    await settingsStore.updateSetting('chatOptions', { ...settingsStore.chatOptions, temperature: 0.8 })
  ...
  it('updateChatOptions merges options and saves', async () => {
    const settingsStore = useSettingsStore()
    settingsStore.chatOptions = { ...settingsStore.chatOptions, temperature: 0.7, top_p: 0.9 };
