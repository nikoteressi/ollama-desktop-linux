...
export interface StreamingCallbacks {
  ...
  onThinkingToken?: (payload: { conversation_id: string; content: string }) => void
  ...
  onToolCall?: (payload: { conversation_id: string; name: string; query: string }) => void
  onToolResult?: (payload: { conversation_id: string; content: string }) => void
}
